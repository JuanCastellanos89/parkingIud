...
public class pagoVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(cbxPlaca, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 120, -1));
        ...
        jPanel1.add(txtPlaca, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, -1, -1));

        txtIngreso.setEditable(false);
        jPanel1.add(txtIngreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 140, -1));

        txtSalida.setEditable(false);
        jPanel1.add(txtSalida, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 180, 140, -1));
        ...
        btnPagar.setText("FACTURA");
        btnPagar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnPagarMouseClicked(evt);
            }
        });
        jPanel1.add(btnPagar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 180, 110, -1));

        txtTotal.setEditable(false);
        txtTotal.setMinimumSize(new java.awt.Dimension(64, 80));
        jPanel1.add(txtTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 100, 110, -1));

        jLabel13.setFont(new java.awt.Font("Roboto Black", 3, 24)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("REGISTRO DE PAGOS");
